...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}"> {{-- takes care of the csrf error in the console --}}
        <script>
            window.Laravel = { csrfToken: ' csrf_token() ' }//outputs the value of the csrf token
        </script>
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">{{-- bootstrap --}}
    ...
    <script src="{{ asset('js/app.js') }}"></script>{{-- includes the vue js --}}
    </body>
</html>
